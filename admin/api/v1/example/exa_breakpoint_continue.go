...
func (u *FileUploadAndDownloadApi) BreakpointContinue(c *gin.Context) {
	...
	err, pathc := pkg.BreakPointContinue(cen, fileName, chunkNumber, chunkTotal, fileMd5)
	if err != nil {
...
func (b *FileUploadAndDownloadApi) BreakpointContinueFinish(c *gin.Context) {
	fileMd5 := c.Query("fileMd5")
	fileName := c.Query("fileName")
	err, filePath := pkg.MakeFile(fileName, fileMd5)
	if err != nil {
...
func (u *FileUploadAndDownloadApi) RemoveChunk(c *gin.Context) {
	...
	err := pkg.RemoveChunk(file.FileMd5)
	if err != nil {
