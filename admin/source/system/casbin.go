...
func (c *casbin) Initialize() error {
	entities := []adapter.CasbinRule{
		...
		{Ptype: "p", V0: "888", V1: "/systemUser/register", V2: "POST"},
		...
		{Ptype: "p", V0: "888", V1: "/systemUser/getUserInfo", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/systemUser/setUserInfo", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/systemUser/setSelfInfo", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/systemUser/getUserList", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/systemUser/deleteUser", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/systemUser/changePassword", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/systemUser/setUserAuthority", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/systemUser/setUserAuthorities", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/systemUser/resetPassword", V2: "POST"},
		...
		// {Ptype: "p", V0: "888", V1: "/integrations", V2: "GET"},
		// {Ptype: "p", V0: "888", V1: "/integrations/logs", V2: "POST"},
		// {Ptype: "p", V0: "888", V1: "/integration/change", V2: "POST"},
		...
		{Ptype: "p", V0: "8881", V1: "/systemUser/changePassword", V2: "POST"},
		{Ptype: "p", V0: "8881", V1: "/systemUser/getUserList", V2: "POST"},
		{Ptype: "p", V0: "8881", V1: "/systemUser/setUserAuthority", V2: "POST"},
		...
		{Ptype: "p", V0: "8881", V1: "/systemUser/getUserInfo", V2: "GET"},

		{Ptype: "p", V0: "9528", V1: "/base/login", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/systemUser/register", V2: "POST"},
		...
		{Ptype: "p", V0: "9528", V1: "/systemUser/changePassword", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/systemUser/getUserList", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/systemUser/setUserAuthority", V2: "POST"},
		...
		{Ptype: "p", V0: "9528", V1: "/systemUser/getUserInfo", V2: "GET"},
	}
...
func (c *casbin) CheckDataExist() bool {
	if errors.Is(global.DB.Where(adapter.CasbinRule{Ptype: "p", V0: "9528", V1: "GET", V2: "/systemUser/getUserInfo"}).First(&adapter.CasbinRule{}).Error, gorm.ErrRecordNotFound) { // 判断是否存在数据
		return false
	}
	return true
}
