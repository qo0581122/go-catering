...
import {fetchProductCategoryList, createProductCategory, updateProductCategory, deleteProductCategory} from '@/api/product_category.js'
...
export default {
    ...
    methods: {
        handleListData() {
            this.loading = true
            fetchProductCategoryList(this.listQuery).then(res => {
        ...
        handleSubmit(data) {
            ...
            if (this.isEdit) {
                //更新
                updateProductCategory(form).then(res => {
                    this.$message({
                        message: res.msg,
                        type: 'success'
                    });
                ...
                //增加
                createProductCategory(form).then( res=> {
                    this.$message({
                        message: res.msg,
                        type: 'success'
                    });
