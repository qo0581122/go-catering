        ...
        <el-main>
            <el-form :inline="true" >
                <el-form-item label="属性名称">
                    <el-input v-model="listQuery.attribute_name" placeholder="属性名称"></el-input>
                </el-form-item>
...
import {fetchProductAttributeList, createProductAttribute, updateProductAttribute, deleteProductAttribute} from '@/api/product_attribute.js'
...
export default {
    ...
    created() {
        this.handleListData()
        fetchOrderPage(defaultListQuery)
    },
    methods: {
        handleListData() {
            this.loading = true
            fetchProductAttributeList(this.listQuery).then(res => {
        ...
        handleSubmit(data) {
            ...
            if (this.isEdit) {
                //更新
                updateProductAttribute(form).then(res => {
                    this.$message({
                        message: res.msg,
                        type: 'success'
                    });
                ...
                //增加
                createProductAttribute(form).then( res=> {
                    this.$message({
                        message: res.msg,
                        type: 'success'
                    });
