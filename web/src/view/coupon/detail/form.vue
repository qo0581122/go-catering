  ...
  <div>
    ...
    >
      ...
      >
        ...
        <el-form-item label="绑定商品" prop="category_id">
          <el-select v-model="dialogForm.product_id" placeholder="请选择">
            <el-option
        ...
        <el-form-item label="优惠券名称" prop="product_name">
          <el-input
            v-model="dialogForm.coupon_name"
            style="width: 300px"
          ></el-input>
        </el-form-item>
...
<script>
import { fetchProductAll } from "@/api/product.js";
