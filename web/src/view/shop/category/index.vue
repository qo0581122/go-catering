    ...
    <el-container style="margin: 15px 20px 20px 20px">
      <el-main>
        ...
        <el-table :data="data" style="width: 100%" :loading="loading" border>
          ...
          <el-table-column prop="category_name" label="店铺分类名称" />
...
export default {
  ...
  methods: {
    handleListData() {
      this.loading = true
      fetchShopCategoryPage(this.listQuery)
        .then((res) => {
