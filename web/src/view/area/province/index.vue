<template>
  <div>
        ...
        <el-main>
            <el-form :inline="true" >
                <el-form-item label="省名称">
                    <el-input v-model="listQuery.province_name" placeholder="省名称"></el-input>
                </el-form-item>
    ...
    <province-form :dialogVisiable="dialogVisiable" :is-edit="isEdit" :form="form" @visableChange="handleCloseDialog" @submit="handleSubmit"></province-form>
  </div>
</template>
