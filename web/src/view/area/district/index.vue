...
import {fetchDistinctPage, updateDistrict, createDistrict, deleteDistrict} from '@/api/district.js'
...
export default {
    ...
    methods: {
        handleListData() {
            this.loading = true
            fetchDistinctPage(this.listQuery).then(res => {
